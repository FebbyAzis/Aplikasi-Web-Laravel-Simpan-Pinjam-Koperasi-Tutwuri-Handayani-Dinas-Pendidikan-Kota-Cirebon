...
<div class="iq-navbar-header" style="height: 215px;">
      ...
      <div class="conatiner-fluid content-inner mt-n5 py-0" data-aos="fade-up" data-aos-delay="800">
                 ...
                 <div class="card-body">
                    ...
                    <div class="table-responsive">
                       <table id="datatable" class="table table-striped" data-toggle="data-table">
                          ...
                          <tbody>
                            @foreach ($pinjreg as $no=>$item)
                            <tr>
                                
                                <td>{{ $no+1 }}</td>
                                <td><a href="{{route('pinjaman-reguler.show', $item->id)}}">{{ $item->anggota->nama }}</a></td>
                                ...
                                <td>
                                    ...
                                    </form><a class="btn btn-sm btn-primary" href="{{route('pinjaman-reguler.show', $item->id)}}">LIHAT</a>
                                </td>
        ...
        <form action="{{ route('pinjaman-reguler.store') }}" method="POST">
            @csrf
            @method('POST') 
           <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>Lengkapi data dibawah ini untuk menambahkan anggota pinjaman reguler!</p>
                        <div class="row">
                            <div class="form-group">
                                ...
                                <select class="form-select" data-trigger name="anggota_id" id="anggota_id">
                                    ...
                                    @foreach ($angg as $s)
                                    @if (!in_array($s->id, $pinjregOptions))
