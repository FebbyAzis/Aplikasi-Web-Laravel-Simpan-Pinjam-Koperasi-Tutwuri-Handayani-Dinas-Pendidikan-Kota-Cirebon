        ...
        <div class="row">
           <div class="col-sm-12">
              <div class="card">
                 ...
                 <div class="card-body">
                    <p>Berikut adalah tabel data pinjaman reguler seluruh anggota koperasi.</p>
                    @if (session('Success'))
                            ...
                            <tr>
                                ...
                                <td>
                                    <form>
                                        ...
                                        <a class="btn btn-sm btn-primary" href="{{route('pinjaman-reguler.show', $item->id)}}">LIHAT</a>
                                    </form>
                                </td>
