...
<div class="iq-navbar-header" style="height: 215px;">
      ...
      <div class="conatiner-fluid content-inner mt-n5 py-0" data-aos="fade-up" data-aos-delay="800">
        <div class="row">
              ...
              <div class="card">
                 <div class="card-header d-flex justify-content-between">
                    <div class="header-title">
                       <h4 class="card-title">Tabel Data Utang P-3</h4>
                    </div>
                 </div>
                 <div class="card-body">
                            ...
                            <tr>
                                ...
                                <td>
                                    <form>
                                        ...
                                        <a class="btn btn-sm btn-primary" href="{{route('utang-p3.show', $item->id)}}">LIHAT</a>
                                    </form>
                                </td>
           ...
           <form action="{{ route('utang-p3.store') }}" method="POST">
            @csrf
            @method('POST') 
