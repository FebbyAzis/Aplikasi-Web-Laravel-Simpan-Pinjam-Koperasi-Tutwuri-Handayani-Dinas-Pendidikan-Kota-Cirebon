        ...
        <div class="row">
           <div class="col-sm-12">
              <div class="card">
                 ...
                 <div class="card-body">
                    <p>Berikut adalah tabel data simpanan manasuka seluruh anggota koperasi.</p>
                    @if (session('Success'))
                    ...
                    <div class="table-responsive">
                       <table id="datatable" class="table table-striped" data-toggle="data-table">
                          ...
                          <tbody>
                            @foreach ($simpM as $no=>$item)
                            <tr>
                                
                                <td>{{ $no+1 }}</td>
                                <td><a href="{{route('simpanan-manasuka.show', $item->id)}}">{{ $item->anggota->nama }}</a></td>
                                ...
                                <td>
                                    <form>
                                        ...
                                        <a class="btn btn-sm btn-primary" href="{{route('simpanan-manasuka.show', $item->id)}}">LIHAT</a>
                                    </form>
                                </td>
           ...
           <form action="{{ route('simpanan-manasuka.store') }}" method="POST">
            @csrf
            @method('POST') 
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            {{-- <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="exampleInputText1" placeholder="Rp 160000" value="Rp. 150.000" readonly>
                                <input type="hidden" name="simpanan_pokok" value="150000">
                            </div> --}}
                        </div>
                    </div>
                    <div class="modal-footer">
