        ...
        <div class="row">
           ...
           <div class="col-sm-12">
              <div class="card">
                 <div class="card-header d-flex justify-content-between">
                    <div class="header-title">
                       <h4 class="card-title">Tabel Data Utang Pihak Ke-3</h4>
                    </div>
                 </div>
                 <div class="card-body">
                    <p>Berikut adalah tabel data utang pihak ke-3 yang dimiliki anggota.</p>
                    @if (session('Success'))
                       ...
                       <table id="datatable" class="table table-striped" data-toggle="data-table">
                          ...
                          <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form>
                                        <a class="btn btn-sm btn-primary" href="{{url('/utang-p3-anggota', $item->id)}}">LIHAT</a>
                                    </form>
                                </td>
