                    ...
                    <div class="card-body">
                        ...
                        <center>
                            <div class="col-sm-12 pt-2 pb-2">
                                ...
                                @elseif($item->users->foto == 1) 
                                <img src="{{ asset('data_file/users.png') }}" class="img-thumbnail" alt="user-profile" width="150px" height="150px">
                                @else
                                <img src="{{ url('/data_file/'.$item->users->foto) }}" class="img-thumbnail" alt="user-profile" width="150px" height="150px">
                                @endif
                                {{-- @endforeach --}}
                            ...
                            <div class="col-sm-12 pb-3">
                                <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#staticBackdrop{{$item->id}}">
                                   
                                    Ubah Foto Profil
                                </button>
                                
                                @if(!$item->users)
                                <button class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#staticBackdrop4{{$item->id}}" disabled>
                                    Hapus Foto Profil
                                </button>
                                @elseif ($item->users->foto == 1)
                                <button class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#staticBackdrop4{{$item->id}}" disabled>
                                ...
                                @else
                                <button class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#staticBackdrop4{{$item->id}}">
                                    Hapus Foto Profil
                                </button>
                                @endif
                        ...
                        <div class="row m-3">
                            ...
                            <div class="col-sm-8">
                                @if (!$item->users)
                                <p class="text-danger"><b>Anggota belum ditambahkan!</b></p>
                                @else
                                <p><b>{{ $item->users->email }}</b></p>
                                @endif
                                ...
                                @if ($item->status == '1')
                                    <p><b>
                                            ...
                                            <a class="btn btn-sm btn-danger" data-bs-toggle="modal"
                                                data-bs-target="#staticBackdrop1{{ $item->id }}">Non-Aktifkan
                                                Anggota</a>
                                        </b>
                                    </p>
                                @else
                                    <p><b>
                                            ...
                                            <a class="btn btn-sm btn-primary" data-bs-toggle="modal"
                                                data-bs-target="#staticBackdrop1{{ $item->id }}">Aktifkan Anggota</a>
                                        </b></p>
                                @endif
                            </div>
                        </div>
                        ...
                        @empty
                            <center>
                                ...
                                <h5>Anda belum terdaftar sebagai anggota</h5>
                                <br>
                                <p>Hubungi admin koperasi untuk menambahkan anda sebagai anggota untuk melihat data mengenai keuangan anda di koperasi</p>
                                </div>
                            </center>
                        @endforelse
